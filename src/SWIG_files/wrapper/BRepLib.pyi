...
class BRepLib_PointCloudShape:
    def GeneratePointsByDensity(self, theDensity: Optional[float] = 0.0) -> bool: ...
    def GeneratePointsByTriangulation(self) -> bool: ...
    def GetDistance(self) -> float: ...
    def NbPointsByDensity(self, theDensity: Optional[float] = 0.0) -> int: ...
...
breplib_UpdateTolerances = breplib.UpdateTolerances
BRepLib_ToolTriangulatedShape_ComputeNormals = BRepLib_ToolTriangulatedShape.ComputeNormals
BRepLib_ToolTriangulatedShape_ComputeNormals = BRepLib_ToolTriangulatedShape.ComputeNormals
