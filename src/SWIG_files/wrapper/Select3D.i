...
class Select3D_SensitiveCircle : public Select3D_SensitiveEntity {
	public:
		...
		/**** md5 signature: cc5233d4d0e3ca208af93a6ccc088e76 ****/
		%feature("compactdefaultargs") Select3D_SensitiveCircle;
		%feature("autodoc", "Constructs the sensitive circle object defined by the owner theownerid, the circle thecircle and the boolean theisfilled.
...
None
") Select3D_SensitiveCircle;
		 Select3D_SensitiveCircle(const opencascade::handle<SelectMgr_EntityOwner> & theOwnerId, const gp_Circ & theCircle, const Standard_Boolean theIsFilled = Standard_False);

		/****************** Select3D_SensitiveCircle ******************/
		/**** md5 signature: 161d42fa874a3a93c9784c8b6c4df833 ****/
		%feature("compactdefaultargs") Select3D_SensitiveCircle;
...
None
") Select3D_SensitiveCircle;
		 Select3D_SensitiveCircle(const opencascade::handle<SelectMgr_EntityOwner> & theOwnerId, const gp_Circ & theCircle, const Standard_Boolean theIsFilled, const Standard_Integer);

		/****************** BoundingBox ******************/
		/**** md5 signature: 32bbe8c17aea605d2fa20f6fee7f740c ****/
		%feature("compactdefaultargs") BoundingBox;
		%feature("autodoc", "Returns bounding box of the circle. if location transformation is set, it will be applied.
...
") BoundingBox;
		...
		/**** md5 signature: 25c8cb59bf9cf3d8018e9e747d82efdc ****/
		%feature("compactdefaultargs") CenterOfGeometry;
		%feature("autodoc", "Returns center of the circle with transformation applied.
...
") CenterOfGeometry;
		...
		/****************** Circle ******************/
		/**** md5 signature: e0a3983adfb658892829f5c0690e1502 ****/
		%feature("compactdefaultargs") Circle;
		%feature("autodoc", "Returns circle.
...
") Circle;
		...
		/**** md5 signature: 2d4e6989177861b3aea0f57481cfcdfc ****/
		%feature("compactdefaultargs") GetConnected;
		%feature("autodoc", "Returns a copy of this sensitive circle.
...
") NbSubElements;
		...
		%feature("autodoc", "Returns circle radius.
...
") ToBuildBVH;
		...
		%feature("autodoc", "The transformation for gp::xoy() with center in gp::origin(), it specifies the position and orientation of the circle.
