...
") SetExactMethod;
		...
		%feature("autodoc", "Sets limit to compute a distance in the process() function. if the distance greater than thetoleranceforchecking the process() function stopped. use this in case checking of tolerance for best performcnce. has no effect in case using exact method.
